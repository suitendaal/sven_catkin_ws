...
force_bound = 15
force_ext_bound = 8
abs_velocity_bound = 0.02
abs_force_ext_bound = 1
force_ext_zero_bound = 1
abs_force_ext_zero_bound = 1
...
plt.figure()
for i in range(7):
	plt.plot(tau[i].time, (tau[i]-tau[i][0]).value, 'C' + str(i) + '-*', linewidth=linewidth, markersize=markersize1,label='Joint ' + str(i+1))
	plt.plot(tau_j[i].time, (tau_j[i]-tau[i][0]).value, 'C' + str(i) + '*', markersize=markersize2)
...
plt.figure()
for i in range(7):
	plt.plot(tau_ext[i].time, (tau_ext[i]-tau_ext[i][0]).value, 'C' + str(i) + '-*', linewidth=linewidth, markersize=markersize1,label='Joint ' + str(i+1))
	plt.plot(tau_ext_j[i].time, (tau_ext_j[i]-tau_ext[i][0]).value, 'C' + str(i) + '*', markersize=markersize2)
...
plt.figure()
for i in range(3):
	plt.plot(force[i].time, (force[i]-force[i][0]).value, 'C' + str(i) + '-*', linewidth=linewidth, markersize=markersize1,label=labels[i])
	plt.plot(force_j[i].time, (force_j[i]-force[i][0]).value, 'C' + str(i) + '*', markersize=markersize2)
...
plt.figure()
for i in range(3):
	plt.plot(force_ext[i].time, (force_ext[i]-force_ext[i][0]).value, 'C' + str(i) + '-*', linewidth=linewidth, markersize=markersize1,label=labels[i])
	plt.plot(force_ext_j[i].time, (force_ext_j[i]-force_ext[i][0]).value, 'C' + str(i) + '*', markersize=markersize2)
...
plt.figure()
plt.plot(abs_velocity.time, abs_velocity.value, 'C0-*', linewidth=linewidth, markersize=markersize1,label='Magnitude')
plt.plot(abs_velocity_j.time, abs_velocity_j.value, 'C0*', markersize=markersize2)
...
plt.figure()
plt.plot(abs_velocity.time, abs(abs_velocity-abs_velocity_pred).value, 'C0-*', linewidth=linewidth, markersize=markersize1,label='Magnitude')
plt.plot(abs_velocity_j.time, abs(abs_velocity_j-abs_velocity_pred_j).value, 'C0*', markersize=markersize2)
...
# TODO: force ext magnitude, zero order force ext x2
