...
# Define datafile
bagfile = 'data/replay6.3.bag'
robot_reader = RobotReader(bagfile)
...
save_figs = False
show_figs = True
figure_dir = 'figures/different_plots2'
...
# Read datasets
for i in range(len(robot_reader.msgs)):
	dp = robot_reader.next_datapoint()
	time = dp.time
	value = dp.value
